export function encodeBase64(string: string) {
    const UTF8Array = strToUTF8Arr(string);
    return base64EncArr(UTF8Array);
}

export function decodeBase64(string: string) {
    const UTF8Array = base64DecToArr(string, 1);
    return UTF8ArrToStr(UTF8Array);
}
...
function UTF8ArrToStr(aBytes: any) {
    var sView = '';
...
function strToUTF8Arr(sDOMStr: any) {
    var aBytes,
        nChr,
